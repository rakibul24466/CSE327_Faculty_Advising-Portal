# Generated by Django 4.1.7 on 2023-06-24 07:11
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Classroom',
            fields=[
                ('building', models.CharField(choices=[('SAC', 'South Academic Buidling'), ('NAC', 'North Academic Buidling'), ('LIB', 'Library Building'), ('ADMIN', 'Admin Building')], max_length=10, verbose_name='academic building abbbrebiation')),
        ...
        migrations.CreateModel(
            name='Section',
            fields=[
                ('no', models.IntegerField(primary_key=True, serialize=False, unique=True, verbose_name='Section no')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('class_slot', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='api.classslot', verbose_name='Class slot')),
                ('classroom', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='api.classroom', verbose_name='Classroom')),
                ('faculty', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='api.educator', verbose_name='Faculty Name')),
                ('section', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='api.course', verbose_name='Course Section')),
            ],
            options={
